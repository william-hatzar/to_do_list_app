                  ...
                  child: FutureBuilder<PaginatedResponse>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return ReorderableListView(
                            onReorder: (int oldIndex, int newIndex) {
                              setState(() {
                                ...
                                final TodoItem item = filteredTasks.removeAt(oldIndex);
                        ...
                        Dismissible(
                          key: ValueKey<int>(index), // Provide a unique key based on the item's index
                          onDismissed: (direction) {
                            final itemId = filteredTasks[index].id;
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: filteredTasks[index].isCompleted
                                              ? const Icon(
                                            Icons.check,
                                            size: 16,
...
class FilterBox extends StatelessWidget {
  ...
  const FilterBox({Key? key, required this.currentFilter, required this.updateFilterCallback, required this.darkMode});
